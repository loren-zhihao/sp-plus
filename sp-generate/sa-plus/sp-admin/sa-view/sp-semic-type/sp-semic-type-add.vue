      ...
      <el-form>
        ...
        <div style="height: 0px; overflow: hidden;">
          ...
          <el-input type="password" />
        						...
        						<sa-item type="text" name="类型如1：系统2：其他，用户可以自定义" v-model="m.type" br></sa-item>
        						<sa-item type="text" name="类型说明" v-model="m.name" br></sa-item>
...
export default {
  ...
  created: function() {
    // 加载角色
    sa.ajax('/spSemicType/getList', function(res) {
  ...
  methods: {
    ...
    ok: function(){
      ...
      // 添加
      sa.ajax('/spSemicType/add', m, function(res) {
